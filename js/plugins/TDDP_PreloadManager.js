    ...
    PreloadManager.preloadImages = function(type, filename, hue) {
        if(filename.constructor === Array) {
            ...
            if(filename.length > 0) {
                ...
                var func = "reserve" + type.charAt(0).toUpperCase() + type.substr(1).toLowerCase();
                ...
                ImageManager[func](filename, hue, Utils.generateRuntimeId()).addLoadListener(this.onFileLoaded.bind(this, "(" + type + ") " + filename));
